...
$pageTitle = $campaign ? $campaign['title'] : 'Ajude o Pedro';
...
<main class="container py-5">
    <div class="soft-card p-5 text-center">
        ...
        <h1 class="h2 fw-bold">A campanha está sendo preparada.</h1>
        <p class="text-secondary mb-0">Em breve você poderá participar da rifa solidária do Pedro.</p>
    </div>
</main>
        ...
        <div class="row g-5 align-items-center">
            <div class="col-lg-6">
                ...
                <div class="d-flex flex-wrap gap-2 mb-4">
                    <a class="btn btn-primary btn-lg rounded-pill px-4" href="#numeros"><i class="bi bi-ticket-perforated me-2"></i>Escolher meus números</a>
                    <a class="btn btn-light btn-lg rounded-pill px-4 border" href="#historia"><i class="bi bi-heart me-2"></i>Conhecer a história</a>
                </div>
                <div class="soft-card p-3 p-md-4">
                    <div class="d-flex justify-content-between gap-3 mb-2">
                        <div><div class="small text-secondary">Arrecadado</div><div class="stat-number"><?= money($stats['raised']) ?></div></div>
                        <?php if ((float) $campaign['goal_amount'] > 0): ?>
                        <div class="text-end"><div class="small text-secondary">Meta</div><div class="stat-number"><?= money($campaign['goal_amount']) ?></div></div>
                        <?php else: ?>
                        <div class="text-end"><div class="small text-secondary">Números confirmados</div><div class="stat-number"><?= (int) $stats['sold'] ?></div></div>
                        <?php endif; ?>
                    </div>
            ...
            <div class="col-lg-6">
                <div class="hero-photo">
                    ...
                    <div class="hero-badge"><i class="bi bi-heart-pulse-fill text-primary me-2"></i><strong>Ajude o Pedro</strong></div>
                </div>
            </div>
        </div>
    </div>
...
<section class="py-5 bg-white border-top border-bottom" id="numeros">
    <div class="container">
        <div class="text-center mx-auto mb-5" style="max-width:760px">
            ...
            <p class="text-secondary">Cada número custa <?= money($campaign['number_price']) ?>. Os números ficam reservados por <?= (int) config('app.reservation_minutes', 30) ?> minutos enquanto você realiza o Pix.</p>
        </div>
        ...
        <form method="post" action="<?= e(url('/reservar.php')) ?>" class="row g-4" data-raffle-form data-price="<?= e((string) $campaign['number_price']) ?>" data-digits="<?= $digits ?>">
            ...
            <div class="col-lg-4">
                <div class="soft-card p-4 checkout-card">
                    ...
                    <button class="btn btn-primary btn-lg w-100" data-submit disabled>Reservar e pagar com Pix</button>
                    <p class="small text-secondary text-center mt-3 mb-0"><i class="bi bi-lock me-1"></i>Seus dados são usados apenas para identificar sua participação.</p>
                </div>
            </div>
        </form>
    </div>
...
<section class="py-5">
    <div class="container text-center" style="max-width:800px">
        <div class="soft-card p-4 p-md-5">
            ...
            <p class="text-secondary">Compartilhar essa campanha também é uma enorme ajuda. Quanto mais pessoas conhecerem a história do Pedro, mais perto chegamos do objetivo.</p>
